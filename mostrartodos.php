...
<div class="row collapse">
 ...
 <br><br><br>
       ...
       <p><i><strong><h3>Lista de Clientes </h3></strong></i></p></center>
...
<input class="sucess button" type="button" value="volver" title="volver" onClick="window.location='indexb.php';"/>
			</div> </div>	</div> </div>	</div>
