...
<a href="javascript:void(0);"  onClick="window.location='editarempleado.php?id=<?php echo $reg[$i]["idempleado"];?>';" title="Editar registro"><img src="ima/editar.png" border="0"></a>
</td>
<td valign="top" align="center" width="10">
<a href="javascript:void(0);" onClick="eliminar('eliminar.php?id=<?php echo $reg[$i]["idempleado"];?>');" title="Eliminar registro"><img src="ima/borrar.png" border="0"></a>
...
<p><i><strong><h3>Creando servicios de calidad! </h3></strong></i></p>
    ...
    <div class="row">
        ...
        <h5>Elija el empleado a editar </h5>
