...
<td valign="top" align="center" width="20">
<a href="javascript:void(0);"  onClick="window.location='editarnota.php?id=<?php echo $reg[$i]["idnota"];?>';" title="Editar registro"><img src="ima/editar.png" border="0"></a>
</td>
<td valign="top" align="center" width="20">
<a href="javascript:void(0);" onClick="eliminar('eliminarnota.php?id=<?php echo $reg[$i]["idnota"];?>');" title="Eliminar registro"><img src="ima/borrar.png" border="0"></a>
</td>
</tr>
<?php
} 
...
<div class="row collapse">
 ...
 <br><br><br>
       ...
       <p><i><strong><h3>Elija la nota a editar </h3></strong></i></p></center>
...
<input class="sucess button" type="button" value="volver" title="volver" onClick="window.location='notas.php';"/>
			</div> </div>	</div> </div>	</div>
