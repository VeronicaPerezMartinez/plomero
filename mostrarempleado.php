...
$reg=$tra->muestra_empleados($_GET['id']);
...
<body onload="limpiar();">
 ...
 <div class="row">
<center>
<form name="form" action="mostrarempleado.php" method="post">
		  ...
		  <div class="small-12 columns">
			 ...
			 <div class="primary callout">
			 	<center><p><strong><h1></h1></strong><img src="ima/logonew.jpg" border="0" width="500" height="500"></p></center>
			  	 <p><i><strong><h3>Resultados de empleados que coinciden con su busqueda </h3></strong></i></p>
...
{?>
            <div class="large-4 medium-4 columns">
              ...
              <input type="text" name="Nombre" value="<?php echo $reg[$i]["nombreempleado"];?>" placeholder="large-4.columns" />
			...
			<div class="large-4 medium-4 columns">
              <label>Fecha</label>
              <input type="text" name="Fecha" value="<?php echo $reg[$i]["fecha_alta"];?>" placeholder="large-4.columns" />
            </div>	
