...
class Trabajo
{
	...
	//$Nota
		public function edit_notas($Cantidad,$Descripcion,$Servicio,$Materiales,$Importe,$Abono,$Pagado,$id1)
	{
	...
	$sql="update notas set cantidad='$Cantidad', descripcion='$Descripcion', servicio='$Servicio', materiales='$Materiales', importe='$Importe', abono='$Abono', pagado='$Pagado', cancelada='$Cancelada', detalles='$Detalles' where idnota='$id1'";
	$res=mysqli_query(Conectar::conexion(),$sql);
	echo "<script type='text/javascript'>
	alert('El registro ha sido modificado correctamente');
	window.location='notas.php';
